...
body{
  ...
  align-items: center;
  background: rgb(201, 107, 31);
    background: linear-gradient(90deg, rgb(88, 224, 25) 0%, rgb(163, 230, 8) 35%, rgba(213, 236, 6, 0.925) 100%);
}
  ...
  <body>
    ...
    <div class="contact-section">
      <div class="contact-info">
        ...
        <div><i class="fas fa-envelope"></i>uic.20mca1006@gmail.com</div>
