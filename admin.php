		...
		<section>
		  <div class="row" id="header">
		    <div class="col-md-12 m-auto block">
		      <center><h2><i>Student Information Management System</i></h2><center>
          <a href="index.html"><button class="btn" style="background-color:green;">Home<i class="fas fa-user"></i></button></a>
		    </div>
		  </div>
		</section>
    <!-- Header code ends -->
