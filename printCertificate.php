    ...
    <div class="row">
      <div class="col-md-8 m-auto block">
        <center>
          ...
          <p>
            This is to certified that <b>Mr. <?php echo $fname . " " . $lname;?></b>
            S/o <b>Mr. <?php echo $father_name;?></b> has successfully completed his/her schooling from our school and now he/she is releaved from here to join next.
